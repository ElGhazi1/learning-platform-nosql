...
2. **Récupération d'un cours valide**
   ...
   - **Capture d'écran** :
     ![GET Valid ID](screens/TESTs_postman/GET_from_courses_collections_valide_ID.PNG)
...
3. **Récupération d'un cours invalide**
   ...
   - **Capture d'écran** :
     ![GET Invalid ID](screens/TESTs_postman/GET_from_courses_collections_invalide_ID.PNG)

4. **Statistiques des cours**
   - **URL** : `GET http://localhost:3000/courses/stats`
   - **Résultat attendu** : Code 200 avec le total des cours.
   - **Capture d'écran** :
     ![GET Stats](screens/TESTs_postman/GET_courses_collection_stats.PNG)

5. **Cours non trouvé**
   - **URL** : `GET http://localhost:3000/courses/notfound`
   - **Résultat attendu** : Code 404 avec un message "Cours non trouvé".
   - **Capture d'écran** :
     ![GET Not Found](screens/TESTs_postman/GET_from_courses_NOT_found.PNG)
